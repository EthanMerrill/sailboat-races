...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between py-20 px-10">
      ...
      <p className='p-10 text-gray-800'>A map of races and venues where you can join a fleet and connect with others. From small community boating programs to highly competitive yacht clubs this site aims to make it easy to get connected with the racing community wherever you are.</p>
